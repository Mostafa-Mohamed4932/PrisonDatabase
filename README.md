...
This project is a web application that provides a database system for managing inmates, cell blocks, guards, cells, and shifts in a prison. The system is built using Microsoft SQL Server for the database management and Node.js with Pug and CSS for the web development.
